...
button3 = types.InlineKeyboardButton(text='🔝10 popular pairs', callback_data='10pp')
button4 = types.InlineKeyboardButton(text='🔍Track everything', callback_data='trall')
...
markup_menu.add(button1,button2,button3,button4,button5,button6)
...
markup_settings.add(button1,button2,button3)
